...
imagenes.forEach((img) => {
  img.addEventListener("click", (e) => {
    ...
    const desayuno = comida.comida.desayunos[index];

    if (!desayuno) return; // seguridad extra

    h2.textContent = desayuno.nombre;
    parrafo.textContent = desayuno.descripcion;
    precio.textContent = "Q" + desayuno.precio;

...
imagenes.forEach((img) => {
  img.addEventListener("click", (e) => {
    ...
    const almuerzo = comida.comida.almuerzos[index];

    if (!almuerzo) return; // seguridad extra

    h2.textContent = almuerzo.nombre;
    parrafo.textContent = almuerzo.descripcion;
    precio.textContent = "Q" + almuerzo.precio;
